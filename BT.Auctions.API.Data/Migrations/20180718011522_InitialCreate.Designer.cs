...
namespace BT.Auctions.API.Data.Migrations
{
    ...
    [Migration("20180718011522_InitialCreate")]
            ...
            modelBuilder.Entity("BT.Auctions.API.Models.AuctionSession", b =>
                {
                    ...
                    b.Property<int?>("DisplayGroupId1");
                    ...
                    b.HasIndex("DisplayGroupId")
                        .IsUnique()
                        .HasFilter("[DisplayGroupId] IS NOT NULL");

                    b.HasIndex("DisplayGroupId1");
            ...
            modelBuilder.Entity("BT.Auctions.API.Models.DisplayGroupConfigurations", b =>
                {
                    ...
                    b.ToTable("DisplayGroupConfiguration");
                });
            ...
            modelBuilder.Entity("BT.Auctions.API.Models.AuctionSession", b =>
                {
                    b.HasOne("BT.Auctions.API.Models.DisplayGroup", "DisplayGroup")
                        .WithOne()
                        .HasForeignKey("BT.Auctions.API.Models.AuctionSession", "DisplayGroupId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("BT.Auctions.API.Models.DisplayGroup")
                        .WithMany("AuctionSessions")
                        .HasForeignKey("DisplayGroupId1");
