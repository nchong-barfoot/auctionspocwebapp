...
namespace BT.Auctions.API.Data.Migrations
{
    ...
    [Migration("20181004024547_LotInfoRenameAndIndexUniqueConstraint")]
    partial class LotInfoRenameAndIndexUniqueConstraint
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BT.Auctions.API.Models.LotDetail", b =>
                {
                    ...
                    b.HasKey("LotDetailId");

                    b.HasIndex("LotId");

                    b.HasIndex("Key", "LotId")
                        .IsUnique();
