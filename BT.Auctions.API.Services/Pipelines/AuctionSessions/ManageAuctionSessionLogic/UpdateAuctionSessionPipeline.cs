...
namespace BT.Auctions.API.Services.Pipelines.AuctionSessions.ManageAuctionSessionLogic
{
    ...
    public class UpdateAuctionSessionPipeline : LogicPipeline<AuctionSession>
    {
        public UpdateAuctionSessionPipeline(ILogger<AuctionSession> logger, IAuctionSessionRepository auctionSessionRepository, IVenueRepository venueRepository, IDisplayGroupRepository displayGroupRepository) : base(logger)
        {
            ...
            Add(new UpdateAuctionSession(auctionSessionRepository));
        }
    }
}